...
def _update_optidice_ub(
    ...
    return (
        ...
        new_nu_state,
        new_critic,
        {**actor_info, **nu_state_info, **critic_info},
    )
...
def _update_roidice_ub(
    ...
    return (
        ...
        new_cost_t,
        new_critic,
        {**actor_info, **nu_state_info, **cost_mu_info, **cost_t_info, **critic_info},
    )
